...
const Navbar = () => {
  ...
  <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
    ...
    <li className="border-b-2 border-zinc-300 w-full"><Link onClick={handleClose} to="about"smooth={true} offset={-150} duration={500}>About</Link></li>
    ...
    <li className="border-b-2 border-zinc-300 w-full"><Link onClick={handleClose} to="pricing"smooth={true} offset={-50} duration={500}>Contact</Link></li>
